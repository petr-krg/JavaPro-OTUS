package krg.petr.otusru.controllers;
...
public class MessageController {
    ...
    private static final long AGGREGATOR_ROOM = 1408;
    ...
    public void getMessage(@DestinationVariable String roomId, Message message) {
        if (String.valueOf(AGGREGATOR_ROOM).equals(roomId)) {
            logger.info("The message is not saved because the chat with the ID {} is read-only", roomId);
            return;
        }
